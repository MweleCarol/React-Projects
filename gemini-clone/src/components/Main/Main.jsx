    ...
    return (
        <div className="main">
            ...
            <div className="main-container">
                ...
                <>
                    <div className="greet">
                        <p><span>Hello , Masha.</span></p>
                        <p>How can I help you today?</p>
                    </div>
                
                    <div className="cards">
                        <div className="card">
                            <p>Suggest beautiful places to see in the upcoming roadtrip</p>
                        ...
                        <div className="card">
                            <p>Brain storm team building  activities for our work retreat</p>
                            <img src={assets.message_icon} alt="" />
                        </div>

                        <div className="card">
                            <p>Improve this code's readability</p>
